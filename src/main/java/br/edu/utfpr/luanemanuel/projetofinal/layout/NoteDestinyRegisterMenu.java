...
public class NoteDestinyRegisterMenu extends javax.swing.JFrame {
    
    private int companyCod;

    public NoteDestinyRegisterMenu(int companyCod) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Cadastro de Notebook");
        ...
        questionLabel.setText("Selecione para quem deseja cadastrar:");
    ...
    private void selectButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectButtonActionPerformed
        ...
        try{
            if(!codTextLabel.getText().isEmpty()){
                    ...
                    if(customer != null){
                        new NotebookRegister(companyCod, isClient, customer.getCod(), 0).setVisible(true);
                        dispose();
                    }else{
                    ...
                    if(employee != null){
                        new NotebookRegister(companyCod, isClient, 0, employee.getCod()).setVisible(true);
                        dispose();
                    }else{
