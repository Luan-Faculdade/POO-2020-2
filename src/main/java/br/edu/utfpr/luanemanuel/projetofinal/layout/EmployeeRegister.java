...
public class EmployeeRegister extends javax.swing.JFrame {
    ...
    public EmployeeRegister(int companyCod) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Sistema de Cadastro - Cadastro de Funcionário");
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Cadastramento de Funcionario");
    ...
    private void registerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButtonActionPerformed
        EmployeeManager employeeManager = NoteMain.companyManager.getCompany(companyCod).getEmployeeManager();
        ...
        try{
            if(!nameFormTextField.getText().isEmpty() && !codFormTextField.getText().isEmpty()
                ...
                employee.setCod(Integer.parseInt(codFormTextField.getText()));
                ...
                if(employeeManager.getEmployee(employee.getCod()) != null){
                    JOptionPane.showMessageDialog(null, "Funcionário já cadastrado!");
                }else{
                    employeeManager.addEmployee(employee);
                    int result = JOptionPane.showConfirmDialog(null, "Cadastro do funcionário de código " + employee.getCod() + " efetuado com sucesso! \nDeseja cadastrar mais?", "Funcionario adicionado com sucesso", JOptionPane.YES_NO_OPTION);
                    if(result == JOptionPane.YES_OPTION){
                        codFormTextField.setText("");
                        nameFormTextField.setText("");
                        cpfFormTextField.setText("");
                        wageFormTextField.setText("");
                        functionFormTextField.setText("");
