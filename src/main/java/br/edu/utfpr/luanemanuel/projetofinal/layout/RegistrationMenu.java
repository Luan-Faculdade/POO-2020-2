...
public class RegistrationMenu extends javax.swing.JFrame {
    ...
    public RegistrationMenu() {
        ...
        this.setTitle("Sistema de Cadastro - Menu de Cadastramento");
    ...
    private void initComponents() {
        ...
        titleLabel.setText("Menu de Cadastramento");
        ...
        try{
            ...
            if(input != null){                
                ...
                if(NoteMain.companyManager.getCompany(companyCod) == null){
                    ...
                    new CustomerRegister(companyCod).setVisible(true);
                    dispose();
                }
            }
        ...
        try{
            ...
            if(input != null){                
                ...
                if(NoteMain.companyManager.getCompany(companyCod) == null){
                    ...
                    new EmployeeRegister(companyCod).setVisible(true);
                    dispose();
                }
            }
        }catch(NumberFormatException e){
        ...
        try{
            ...
            if(input != null){                
                ...
                if(NoteMain.companyManager.getCompany(companyCod) == null){
                    ...
                    new NoteDestinyRegisterMenu(companyCod).setVisible(true);
                    dispose();
                }
            }
        }catch(NumberFormatException e){
